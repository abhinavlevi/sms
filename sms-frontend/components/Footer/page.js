  ...
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <form className="w-full">
            ...
            >
              <input
                                            ...
                                            autoComplete="email"
                                            required
                                            className="appearance-none rounded-md relative block w-full px-3 py-2 border  placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-[#841FEB] focus:border-[#841FEB] focus:z-10 sm:text-sm"
                                            placeholder="Enter your email address"
                                        />

              <button
                className="mt-1 w-full bg-[#841FEB] px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-[#933ee7] sm:mt-0 sm:w-auto sm:shrink-0 rounded-md"
              >
                Sign Up
              </button>
            </div>
    ...
    <div className="mt-8 border-t border-gray-100 pt-8">
      <div className="sm:flex sm:justify-between">
        <p className="text-xs text-gray-500">&copy; {currentYear}. <span className='text-[#841FEB] font-bold'>XanForm.</span> All rights reserved.</p>
