...
const page = () => {
  return (
    ...
    <div className='flex justify-around bg-gray-100 w-full h-screen flex-col-reverse'>
    ...
    <div className="signform z-[4] w-1/2 min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8 lg-bg-gray-500">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="formbg bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
